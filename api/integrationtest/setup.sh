...
# 0009 (needs the real Storage extension), and prints the env var to
# export before running: go test ./integrationtest/...
set -euo pipefail
...
echo "Applying migrations (excluding 0009, Supabase-only)..."
TMP_DIR="$(mktemp -d)"
